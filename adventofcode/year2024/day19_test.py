...
from adventofcode.year2024 import day19
...
class TestDay:
    @pytest.mark.parametrize(testit.names, [(example, 6), (answer, 240)], ids=testit.ids())
    def test_first_star(self, indata: str, want: int) -> None:
        testit.first_star(day19.Day(indata), want)

    @pytest.mark.parametrize(testit.names, [(example, 16), (answer, 848076019766013)], ids=testit.ids())
    def test_second_star(self, indata: str, want: int) -> None:
        testit.second_star(day19.Day(indata), want)
