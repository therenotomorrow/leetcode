...
func TestValidateBinaryTreeNodes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "test 36: wrong answer", args: args{n: 6, leftChild: []int{1, -1, -1, 4, -1, -1}, rightChild: []int{2, -1, -1, 5, -1, -1}}, want: false},
		{name: "test 42: wrong answer", args: args{n: 3, leftChild: []int{1, -1, -1}, rightChild: []int{-1, -1, 1}}, want: false},
	}
